 ...
 * Name = weather_rain
 * DateTime = Tue Mar 08 2022 11:32:55 GMT+0800 (China Standard Time)
 * Author = canvas
 * FileBasename = weather-rain.ts
 * FileBasenameNoExtension = weather-rain
 * URL = db://assets/scripts/logic/weather/weather-rain.ts
